...
mod tests {
    ...
    #[test]
    fn eval_std_test_helpers_module() {
        ...
        let result = eval_module_source(source, "test_helpers_vm");
        assert_eq!(result, 1);
    }

    #[test]
    fn eval_std_json_helpers_module() {
        ...
        let result = eval_module_source(source, "json_helpers_vm");
        assert_eq!(result, 1);
    }
